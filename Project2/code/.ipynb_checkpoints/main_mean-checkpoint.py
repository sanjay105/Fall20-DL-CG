...
test_mean_path = '/blue/cis6930/sbanda/color/'
...
def main():
    ...
    # Channel does compute mean values
    is_mean = True
    ...
    torch.save(model.state_dict(), '/home/sbanda/Fall20-DL-CG/Project2/Finale/models/model_mean.pkl')
    
    # Validate the trained model with test set
    predictMean('/home/sbanda/Fall20-DL-CG/Project2/Finale/models/model_mean.pkl',test_mean_path)

...
from generate_stylized_image import generate_stylized_image


def verify_dirs(args):
    """
    If required directories doesn't exist, this method creates them
    :param args: File directories
    :return: void
    """
    try:
...
def main():
    """
    Entry point -> loads the arguments, and call necessary python files
    :return: void
    """
